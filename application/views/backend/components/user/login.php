<html lang="">
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" style="color:#337ab7">Smart Phone</h2>
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2021 <a href="#" style="color:red">ngonguyenkminh.dsn</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
